...
import { toggleAddPaymentModal } from '../app/appSlice';
...
function AddPaymentModal() {
    ...
    return (
        <Modal center onClose={() => dispatch(toggleAddPaymentModal(false))} className="add-card-modal">
            <ModalHeader closeBtn className="py-9 px-4">
                <h3>Add Card</h3>
            </ModalHeader>
