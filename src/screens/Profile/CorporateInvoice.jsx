...
export function CorporateInvoice() {
        ...
        <div>
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="input-group has-floating-label mb-5">
                    <input type="text" {...register('vatNumber', { required: true })} className={`input-control ${errors.vatNumber && 'error'}`} placeholder="VAT number" />
                    <label htmlFor="vatNumber" className="label-control">VAT number</label>

                    {errors.vatNumber && <Icon icon="ant-design:info-circle-outlined" className="error-icon" />}
                ...
                <div className="input-group has-floating-label mb-5">
                    <input type="text" name="taxOffice" id="taxOffice" className="input-control" placeholder="Tax Office" disabled={true} style={{ backgroundColor: 'var(--color-gray-light)' }} />
                    <label htmlFor="taxOffice" className="label-control">Tax Office</label>
                </div>
